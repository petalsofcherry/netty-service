...
import com.ncuos.promote.entity.User;
import com.ncuos.promote.util.NettyUtil;
...
public class UserManager {
    ...
    private static ConcurrentMap<Channel, User> userInfos = new ConcurrentHashMap<>();
    ...
    public static boolean saveUser(Channel channel, String nick) {
        User userInfo = userInfos.get(channel);
        if (userInfo == null) {
            return false;
        }
        if (!channel.isActive()) {
    ...
    public static void removeChannel(Channel channel) {
        try {
            ...
            User userInfo = userInfos.get(channel);
            if (userInfo != null) {
                User tmp = userInfos.remove(channel);
